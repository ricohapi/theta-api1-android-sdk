				...
				objectList.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
						...
						if (selectedItem.isPhoto()) {
							...
							PhotoActivity.startActivity(ObjectListActivity.this, cameraIpAddress, objectHandle, thumbnail);
						} else {
	...
	private class GetThumbnailTask extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			try {
				...
				PhotoActivity.startActivity(ObjectListActivity.this, cameraIpAddress, objectHandle, thumbnailImage);
				return null;
